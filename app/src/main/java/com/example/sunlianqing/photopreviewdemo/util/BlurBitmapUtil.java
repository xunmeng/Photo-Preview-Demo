...
public class BlurBitmapUtil {
	 ...
	 * @param context   上下文对象
	 * @param image     需要模糊的图片
	 * @param blurRadius  goss 模糊程度
	 * @param scaleRatio  缩小比例
	 * @param outWidth  输入出的宽度
	 * @param outHeight 输出的高度
	 * @return 模糊处理后的Bitmap
	 */
	@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
	public Bitmap blurBitmap(Context context, Bitmap image, float blurRadius, int scaleRatio, int outWidth, int outHeight) {
